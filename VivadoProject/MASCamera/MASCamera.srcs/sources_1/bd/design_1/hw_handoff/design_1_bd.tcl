...
proc create_root_design { parentCell } {
  ...
  set CAMERA [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 CAMERA ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports CAMERA] [get_bd_intf_pins axi_gpio_1/GPIO]
